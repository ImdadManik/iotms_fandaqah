...
{
    [DbContext(typeof(iotmsDbContext))]
    partial class iotmsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iotms.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("iotms.Devices.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<short>("LDRAlertFreq")
                        .HasMaxLength(1440)
                        .HasColumnType("smallint")
                        .HasColumnName("LDRAlertFreq");
                    ...
                    b.Property<short>("MinLDRAlert")
                        .HasMaxLength(255)
                        .HasColumnType("smallint")
                        .HasColumnName("MinLDRAlert");

                    b.Property<short>("MinTempAlert")
                        .HasMaxLength(50)
                        .HasColumnType("smallint")
                        .HasColumnName("MinTempAlert");
                    ...
                    b.Property<short>("TempAlertFreq")
                        .HasMaxLength(1440)
                        .HasColumnType("smallint")
                        .HasColumnName("TempAlertFreq");
            ...
            modelBuilder.Entity("iotms.Devices.Device", b =>
                {
                    b.HasOne("iotms.Accounts.Account", null)
                        .WithMany("Devices")
