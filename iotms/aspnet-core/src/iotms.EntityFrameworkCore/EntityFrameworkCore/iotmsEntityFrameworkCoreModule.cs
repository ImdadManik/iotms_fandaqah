...
public class iotmsEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<iotmsDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also iotmsDbContextFactory for EF Core tooling. */
            options.UseMySQL();
        });
