...
public class iotmsDbMigrationService : ITransientDependency
{
    public ILogger<iotmsDbMigrationService> Logger { get; set; }
    ...
    public iotmsDbMigrationService(
        ...
        IEnumerable<IiotmsDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<iotmsDbMigrationService>.Instance;
    }
